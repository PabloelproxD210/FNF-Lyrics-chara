...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bambi-angey':
				iconColor = 'FF0cb500';
				tex = Paths.getSparrowAtlas('bambi/bambimaddddd');
				frames = tex;
			...
			case 'shaggyhot':
				iconColor = 'FFff1c03';
				tex = Paths.getSparrowAtlas('characters/Shaggyhot');
				frames = tex;

				animation.addByPrefix('idle', "Shaggy idle dance", 24, false);
				animation.addByPrefix('singUP', "Shaggy Up", 24, false);
				animation.addByPrefix('singDOWN', "Shaggy Down", 24, false);
				animation.addByPrefix('singLEFT', 'Shaggy Left', 24, false);
				animation.addByPrefix('singRIGHT', 'Shaggy Right', 24, false);

				addOffset('idle', -120, -20);
				addOffset("singUP", -119, 1);
				addOffset("singRIGHT", -120, -20);
				addOffset("singLEFT", -119, -23);
				addOffset("singDOWN", -120, -42);
			...
			case 'bf':
				...
				animation.addByPrefix('singHey', 'BF NOTE UP0', 24, false);
